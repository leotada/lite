...
struct _RenColor { ubyte b, g, r, a; }alias RenColor = _RenColor;

struct _RenRect { int x, y, width, height; }alias RenRect = _RenRect;
...
struct _Clip { int left, top, right, bottom; }private _Clip clip;
...
retry:
  ...
  int res = stbtt_BakeFontBitmap(
    font.data, 0, font.size * s, cast(void*) set.image.pixels,
...
RenFont* ren_load_font(const(char)* filename, float size) {
  ...
  int _ = fread(font.data, 1, buf_size, fp); cast(void) _;
  fclose(fp);
  fp = null;
