...
private uint[CELLS_X * CELLS_Y] cells_buf1;
private uint[CELLS_X * CELLS_Y] cells_buf2;
private uint* cells_prev = cells_buf1;
private uint* cells = cells_buf2;
private RenRect[CELLS_X * CELLS_Y / 2] rect_buf;
private char[COMMAND_BUF_SIZE] command_buf = 0;
private int command_buf_idx;
private RenRect screen_rect;
...
pragma(inline, true) private int min(int a, int b) { return a < b ? a : b; }
pragma(inline, true) private int max(int a, int b) { return a > b ? a : b; }
